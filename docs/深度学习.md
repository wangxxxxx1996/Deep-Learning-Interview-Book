...
$$z_4 = w_{14} \times x_1 + w_{24} \times x_2 + w_{34} \tims x_3 + b_4$$
$$z_5 = w_{15} \times x_1 + w_{25} \times x_2 + w_{35} \tims x_3 + b_5$$
$$z_6 = w_{16} \times x_1 + w_{26} \times x_2 + w_{36} \tims x_3 + b_6$$
...
$$\partial Loss(a_7,y) \div \partial w_{47} = \partial Loss(a_7,y) \div \partial a_7 \times \partial a_7 \divs \partial z_7 \times \partial z_7 \times \patial w_{47}$$
